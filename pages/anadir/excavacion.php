...
<html lang="es">
          ...
          <ul class="list-unstyled panel">
            ...
            <li><span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a title='acceder a añadir a la base de datos' tabindex='1' href="../add_bbdd.php">Añadir BBDD</a>
              <ul class="list-unstyled" id="submenu">
                ...
                <li class="destacar2"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span><a title='acceder a añadir excavaciones' tabindex='1' href="excavacion.php">Excavación</a></li>
        ...
        <div class="col-lg-10 col-md-8 col-xs-12 col-sm-6 contenido">
          ...
          <div class="row">
            <div class="col-lg-offset-0 col-lg-10">
              <h2  tabindex='2' class="titulos">Añadir Excavacion</h2>
              <p tabindex='2' >A continuación, podrá añadir a la base de datos una nueva excavación, teniendo en cuenta algunas de sus características.</p>
              <form class="" action="../add_bbdd/add_excavacion.php" method="post">
                ...
                <div class="row">
                  <div class="col-lg-12 form-group">
                    <textarea tabindex='2' class="form-control" rows="1" id="observaciones_ex" name="observaciones_ex" placeholder="OBSERVACIONES"></textarea>
                  </div>
                </div>
                <div class="row">
  ...
  <script type="text/javascript" src="../../js/anadir/excavacion.js"></script>
  </body>
</html>
