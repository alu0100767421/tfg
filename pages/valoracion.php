      ...
      <div class="row">
        <div class="col-lg-2 col-md-4 col-xs-8 col-sm-6 ">
          <ul class="list-unstyled panel">
            ...
            <li class="destacar"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span><a tabindex='1' href="valoracion.php">Valoraciones</a>
              <ul class="list-unstyled" id="submenu_valoracion">
                ...
                <li><span class="glyphicon glyphicon-minus" aria-hidden="true"></span><a tabindex='1' href="valoraciones/consultar_valoracion.php">Consultar Valoración</a></li>
              </ul>
            </li>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <ul class="list-unstyled" id="submenu">
                <li><a tabindex='2' href="valoraciones/add_valoracion.php">Añadir Valoración</a></li>
                <li><a tabindex='2' href="valoraciones/consultar_valoracion.php">Consultar Valoración</a></li>
              </ul>
            </div>
          </div>
