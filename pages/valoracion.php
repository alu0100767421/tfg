      ...
      <div class="row">
        <div class="col-lg-2 col-md-4 col-xs-8 col-sm-6 ">
          <ul class="list-unstyled panel">
            ...
            <li id="consultar"><span class="glyphicon glyphicon-search" aria-hidden="true"></span><a href="consultar_bbdd.php">Consultar/Eliminar/Modificar</a></li>
            <li class="destacar"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span><a href="valoracion.php">Valoraciones</a>
        ...
        <div class="col-lg-10 col-md-8 col-xs-12 col-sm-6 contenido">
          <h2>Sección para añadir una valoración a cada yacimiento</h2>


          <div class="row">
            <div class="col-lg-12">
              <p>En esta sección, podrá añadir o consultar una valoración bajo el criterio propuesto en cada uno de lo yacimiento:</p>
              <ul class="list-unstyled" id="submenu">
                <li><a href="valoraciones/add_valoracion.php">Añadir Valoración</a></li>
                <li><a href="valoraciones/consultar_valoracion.php">Consultar Valoración</a></li>
              </ul>
            </div>
          </div>
