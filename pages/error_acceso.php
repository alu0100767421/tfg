...
<body>
  ...
  <div class="row">
    <div class="col-lg-offset-4 col-lg-4 col-md-offset-4 col-md-4 col-sm-offset-4 col-sm-4 col-xs-offset-4 col-xs-4">
      <img class="error_acceso" alt="Error de acceso" title="Error de acceso" src="../images/error_acceso.png">
    </div>
  </div>
  <div class="row">
    <div class="col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-4 col-sm-offset-3 col-sm-4 col-xs-offset-3 col-xs-4">
      <h5>Error de acceso. Redirigiendo a página de inicio...</h5>
    </div>
  </div>
